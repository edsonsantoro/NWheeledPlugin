...
#include "NWheeledVehicle.generated.h"
...
class NWHEELEDVEHICLES_API ANWheeledVehicle : public APawn
{
	...
	DEPRECATED_FORGAME(4.6, "VehicleMovement should not be accessed directly, please use GetVehicleMovement() function instead. VehicleMovement will soon be private and your code will not compile.")
		UPROPERTY(Category = Vehicle, VisibleDefaultsOnly, BlueprintReadOnly, meta = (AllowPrivateAccess = "true"))
	class UNWheeledVehicleMovementComponent* VehicleMovement;
public:
	...
	class UNWheeledVehicleMovementComponent* GetVehicleMovementComponent() const;
