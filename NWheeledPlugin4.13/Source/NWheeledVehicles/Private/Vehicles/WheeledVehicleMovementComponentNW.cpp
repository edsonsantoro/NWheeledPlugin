...
#include "Runtime/Engine/Classes/Vehicles/WheeledVehicleMovementComponent4W.h"
...
FVehicleTransmissionData UWheeledVehicleMovementComponentNW::GetGearboxDetails()
{
...
float UWheeledVehicleMovementComponentNW::GetVehicleDragMagnitude()
{
	return DebugDragMagnitude;
}

float UWheeledVehicleMovementComponentNW::GetVehicleDragArea()
{
	return DragArea;
}
